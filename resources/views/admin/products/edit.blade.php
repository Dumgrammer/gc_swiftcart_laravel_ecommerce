            ...
            <div class="card-body">
                ...
                @method('PUT')
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="tab" data-bs-toggle="tab" data-bs-target="#tab-pane" type="button"
                                role="tab" aria-controls="tab-pane" aria-selected="false">Tags</button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade border p-3" id="tab-pane" role="tabpanel" aria-labelledby="tab" tabindex="0">
                            <div class="mb-3">
                                        ...
                                        <tr class="prod-color-tr">
                                            ...
                                            <td>
                                                <div class="input-group mb-3" style="width:150px">
                                                    ...
                                                    <button type="button" value="{{$prodColor->id}}" class="updateProductColorBtn btn btn-success btn-sm text-white">Update</button>
                                                </div>
                                            </td>
                                            <td>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.deleteProductColorBtn', function() {
            ...
            $.ajax({
                ...
                success: function(response){
                    etoClick.closest('.prod-color-tr').remove();
                    alert(response.message);
                }
            });
