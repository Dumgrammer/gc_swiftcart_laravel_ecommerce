            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="shopping-cart">
                        ...
                        {{--okay ayan an yng cart dun sa Cartshow okicks?--}}
                        @if ($cartItem->product)                          
                        <div class="cart-item">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-7 my-auto">
                                    <div class="quantity">
                                        <div class="input-group">
                                            ...
                                            <button type="button" wire:loading.attr="disabled" class="btn btn1" wire:click="incrementQuantity({{$cartItem->id}})"><i class="fa fa-plus"></i></button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-1 my-auto">
